      ...
      <Container>
        <Row>
          <Col>
            ...
            <h1>
              Return-on-Teamarbeit<span style={{ color: "#4285F4" }}>.</span>
            </h1>
        ...
        <Row style={{ marginTop: "4rem" }}>
          <Col md style={{ marginBottom: "4rem" }}>
            <h2>Team-Paket</h2>
            <p>
              Für 1 Team & bis zu 8 Mitglieder<br></br>
              Beinhaltet:
            </p>
            <p>
            ...
            <p>pro Monat</p>
            <Link to="/team-trainings" className="btn btn-secondary btn-lg">
              Mehr erfahren
            </Link>
            <p style={{ fontSize: "1rem" }}>
              1 Monat kostenlos & unverbindlich testen.
            </p>
          </Col>
          <Col md>
            <h2>Enterprise-Paket</h2>
            <p>
              Für 2+ Teams & unbegrenzte Mitglieder<br></br>
              Beinhaltet das Team-Paket, plus:
            </p>
            <p>
            ...
            <p>
              <Emoji symbol="🎓" label="training" /> Selbstgesteuerte
              Weiterbildung<br></br>
              <Emoji symbol="🌐" label="global" /> Unternehmensweite Standards
              <br></br>
            ...
            <p>pro Team/Monat</p>
            <Button variant="secondary" size="lg" href="mailto:moin@crewsby.de">
        ...
        <Row style={{ marginTop: "2rem" }}>
          <Col>
            <p style={{ fontSize: "1rem" }}>
              * Die Übersetzungen und Enterprise-Features sind noch im
              Entwicklungsprozess. Wir arbeiten wirklich hart daran Crewsby
              konstant & schnell zu verbessern.
            </p>
          </Col>
        </Row>
      </Container>
