            ...
            <Container>
              ...
              die beliebig rekombinierbar sind.</p>
                ...
                <Row style={{ marginTop: "1.4rem" }}>
                    ...
                    <Col sm={4}><FontAwesomeIcon icon={['fas', 'check']} fixedWidth color="#4285F4" />{' '}Prozesse optimmieren</Col>
                ...
                <Row style={{ marginTop: "8rem" }}>
                    <Col lg={6}>
                        ...
                        <h2>Alltagstaugliches Training</h2>
                        <p>Unsere Tutorials bauen Fähigkeiten auf — genau wie ein menschlicher Trainer, nur wesentlich flexibler.</p>
                    </Col>
                ...
                <Row style={{ marginTop: "8rem" }}>
                    <Col>
                        ...
                        <p className="mintitle">Doppeltes Training</p>
