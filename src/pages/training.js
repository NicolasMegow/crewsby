      ...
      <Container>
        ...
        <Row style={{ marginTop: "8rem" }}>
          <Col md={6}>
            ...
            <p>
              ...
              Trainiere mit Crewsby alleine oder hol Dein Team ins Boot. Dann
              könnt ihr voneinander & miteinander lernen.
            </p>
          </Col>
          <Col
            md={6}
        ...
        <Row style={{ marginTop: "8rem" }}>
          <Col lg>
            ...
            <p>
              Verbesserung entsteht aus neuen Fähigkeiten. Und das braucht etwas
              Zeit und Wiederholung. Crewsby bietet Dir abwechselungsreiche
              Trainings, die Du beliebig kombinieren kannst, um neue Fähigkeiten
              aufzubauen.
            </p>
          </Col>
          <Col
        ...
        <Row style={{ marginTop: "8rem" }}>
          <Col lg={6}>
            ...
            <p>
              Crewsby läd Dich zum Wechsel Deiner Perspektive ein. So entdeckst
              Du neue Seiten an Dir und Deinen Teammitgliedern. Stück für Stück
              baust Du so neue Fähigkeiten auf und verbesserst die Teamarbeit.
            </p>
          </Col>
          <Col
            lg={6}
