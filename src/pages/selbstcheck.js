    ...
    <Layout>
      ...
      <Container>
        ...
        <Tab.Container id="left-tabs-example" defaultActiveKey="first">
          <Nav variant="pills">
            <Nav.Item>
              <Nav.Link eventKey="first" className={appStyles.pill}>
                <FontAwesomeIcon icon={["fal", "user"]} fixedWidth />
                {"   "}MICH
              </Nav.Link>
            </Nav.Item>
            <Nav.Item>
              <Nav.Link eventKey="second" className={appStyles.pill}>
          ...
          <Tab.Content>
            <Tab.Pane eventKey="first" className={appStyles.tab}>
              ...
              <ListGroup variant="flush" className={appStyles.section}>
                <ListGroup.Item>
                  Ich weiß, wie ich jedem meiner Teammitglieder eine Freude
                  bereiten kann.
                </ListGroup.Item>
                <ListGroup.Item>
                  Ich habe das Gefühl, dass wir alle an einem Strang ziehen.
                </ListGroup.Item>
                <ListGroup.Item>
                  Ich kann Konflikte im Team produktiv lösen.
                </ListGroup.Item>
              ...
              <ListGroup variant="flush" className={appStyles.section}>
                <ListGroup.Item>
                  Ich weiß, welchen Beitrag meine Arbeit zur Zielerreichung
                  leistet.
                </ListGroup.Item>
                <ListGroup.Item>
                  Ich habe das Gefühl, dass wir alle an einem Strang ziehen.
                ...
                <ListGroup.Item>
                  Ich weiß, wann ich im Team die Führung übernehmen sollte.
                </ListGroup.Item>
                <ListGroup.Item>
                  Ich kann auf meine Art souverän die Teamführung übernehmen.
                </ListGroup.Item>
              </ListGroup>
              <h3>Fähigkeiten</h3>
              <ListGroup variant="flush" className={appStyles.section}>
