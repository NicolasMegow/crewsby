...
Another way to approach this is to scan your process for impediments to smooth flow.

- What stops flow or inhibits it?
- Which bottlenecks can be removed?
...
Of course, you can create DoDs for every step of the process to help smooth transitions between steps.
