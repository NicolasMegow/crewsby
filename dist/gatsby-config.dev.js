...
module.exports = {
  ...
  plugins: ["gatsby-plugin-react-helmet", "gatsby-plugin-sass", "gatsby-plugin-sitemap", {
    ...
    options: {
      name: "methoden",
      path: "".concat(__dirname, "/src/content/methoden")
    }
  }, {
    resolve: "gatsby-source-filesystem",
    options: {
      name: "uebungen",
      path: "".concat(__dirname, "/src/content/uebungen")
    }
  }, "gatsby-plugin-sharp", "gatsby-transformer-sharp", "gatsby-remark-images", {
    resolve: "gatsby-plugin-mdx",
    options: {
      gatsbyRemarkPlugins: ["gatsby-remark-relative-images", {
